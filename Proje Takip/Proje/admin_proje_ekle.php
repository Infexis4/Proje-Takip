      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">2209 A Proje Ekleme Formu</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              ...
              if (isset($_POST['film_ekle'])) {
                ...
                if ( mysqli_num_rows($query_sql_film_kontrol) < 1 ) {
                  ...
                  // Proje eklemesi
                  $sql_film = "INSERT INTO projeler (proje_Adi, proje_butce, proje_yil, proje_aciklama, danısman_ID, proje_sayı , proje_ID , durum_id ) 
                              VALUES ('$proje_Adi', '$proje_butce', '$proje_yil', '$proje_aciklama', '$danısman_ID', '$proje_sayı' , '$proje_ID' , '$durum_id')";

                  if (mysqli_query($baglan, $sql_film)) {
                      $projeler_ID = mysqli_insert_id($baglan);

                      // proje türlerini eklemek için döngü
                      if (is_array($_POST['proje_tur']) && count($_POST['proje_tur']) >= 1) {
                        foreach ($_POST['proje_tur'] as $filmturkey => $filmturvalue) {
                            $filmTurKontrol = mysqli_query($baglan, "INSERT INTO proje_tur (tur_ID, projeler_ID) VALUES ('$filmturvalue','$projeler_ID')");     
                        }
                      } else {
                        $filmTurKontrol = mysqli_query($baglan, "INSERT INTO proje_tur (tur_ID, projeler_ID) VALUES ('".$_POST['proje_tur']."','$projeler_ID')");  
                      }
              ...
              <form method="POST" class="my-login-validation" enctype="multipart/form-data" novalidate="">
                ...
                <!-- proje bütçe giriş alanı -->
                <div class="form-group">
                  <label for="name">Proje Bütçesi</label>
                  <input type="number" class="form-control" name="proje_butce" min="0" max="50000"  value="0" required>
                </div>
                ...
                <div class="form-group m-0">
                  <input type="hidden" name="proje_ID" value="1">
