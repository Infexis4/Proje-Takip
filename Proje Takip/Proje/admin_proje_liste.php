                ...
                <div class="table-responsive p-3">
                  <table class="table table-striped" id="dataTable">
                    ...
                    <tbody>
                      ...
                      $sorgu = mysqli_query($baglan, "SELECT * FROM projeler WHERE proje_id = 1");
                      ...
                      if (mysqli_num_rows($sorgu) >= 1) {
                        ...
                        while ($row = mysqli_fetch_array($sorgu)) {
                          ...
                          <tr>
                            ...
                            <!-- danısman ID'sini kullanarak yönetmenin adını al -->
                    ...
                    <?php
                      // danısman ID'sine göre yönetmenin adını almak için fonksiyon
